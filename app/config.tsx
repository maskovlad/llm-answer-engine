...
export const config = {
    ...
    inferenceModel: 'mixtral-8x7b-32768', // Groq: 'mixtral-8x7b-32768', 'gemma-7b-it', 'llama3-8b-8192' // OpenAI: 'gpt-3.5-turbo', 'gpt-4' // Ollama 'mistral', 'llama3' etc
    inferenceAPIKey: process.env.GROQ_API_KEY, // process.env.HUGGINGFACEHUB_API_KEY // Groq: process.env.GROQ_API_KEY // OpenAI: process.env.OPENAI_API_KEY // Ollama: 'ollama' is the default
    ...
    useRateLimiting: false, // Використовує обмеження швидкості Upstash, щоб обмежити кількість запитів на користувача
};
