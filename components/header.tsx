      ...
      <header className="sticky top-0 z-50 flex items-center justify-between w-full px-4 border-b h-14 shrink-0 dark:bg-slate-800 bg-white backdrop-blur-xl">
        <span className="inline-flex items-center home-links whitespace-nowrap">
          ...
          <a className='inline-flex' href="https://developersdigest.tech" rel="noopener" target="_blank">
            <span className="block sm:inline text-lg sm:text-xl lg:text-2xl font-semibold dark:text-white text-black">NAIDA <span className="linear-wipe">ШІстема пошуку відповідей</span></span>
          </a>
        </span>
